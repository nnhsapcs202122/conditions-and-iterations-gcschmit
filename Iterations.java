...
public class Iterations
{
    ...
    public static int sum()
    {
        ...
        do
        {
            ...
            /*
             * Sentinel variable
             *      Value (e.g., -1) used to terminate the loop.
    ...
    public static int sumWithContinue()
    {
        ...
        do
        {
            ...
            /*
             * The hasNetInt method of the Scanner class returns true if the next token
            ...
            if(s.hasNextInt() == false)
            {
                ...
                /*
                 * continue
                 *      1. immediately skips to end of the inner-most loop
                 *      2. re-evaluates the loop condition and continues with the next
                 *          iteration if the condition is true
                 */
                continue;
            }
